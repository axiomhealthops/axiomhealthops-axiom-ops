...
const S = {
  ...
  navItem: { width: 'calc(100% - 8px)', display: 'flex', alignItems: 'center', gap: 10, padding: '7px 12px', background: 'none', border: 'none', color: '#6B7280', fontSize: 13, fontWeight: 400, cursor: 'pointer', textAlign: 'left', borderRadius: 6, margin: '1px 4px' },
